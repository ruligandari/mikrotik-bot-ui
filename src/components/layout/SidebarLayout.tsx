...
export default function SidebarLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-background flex text-foreground">
            ...
            {/* Mobile Nav Header */}
            <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-card/80 backdrop-blur-md border-b border-border z-50 px-6 flex items-center justify-between">
            ...
            {/* Mobile Drawer */}
            {isMobileMenuOpen && (
                <div className="lg:hidden fixed inset-0 bg-background z-40 p-6 pt-20 animate-in slide-in-from-right">
            ...
            {/* Main Content */}
            <main className="flex-1 w-full lg:pt-0 pt-16 overflow-x-hidden animate-in fade-in duration-500">
